...
const Hoarding = ({hoarding}) => {
    ...
    return(
        <li className="    bg-gray-200 rounded-lg mb-2  mx-auto  hover:bg-gray-300 transition-all ">
            ...
            <div className="flex flex-row   gap-6  p-3 justify-center  h-16 max-h-16  items-center    ">
                ...
                <div className={ ` text-sm p-1 border rounded-md ${hoarding.isAvailable ? "  border-lime-700 bg-lime-100   text-lime-700" : "  border-red-700 bg-red-100   text-red-700"}  `}>{hoarding.isAvailable ? " Available" : " Not Available"}</div>
            </div>
